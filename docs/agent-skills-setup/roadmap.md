...
- Improve public release bundles and metadata.
...
- Extend malformed-input, symlink, read-only-target, and non-MCP-object tests.

Completed path single-sourcing is recorded in [HI-001](HI-001-ide-paths-single-source.md).
