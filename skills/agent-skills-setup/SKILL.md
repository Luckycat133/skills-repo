...
- Device handoff (ACB, **version 0.8.24**):
...
- Surface scope: skills, instructions, MCP, prompts, commands, workflows, agents/droids, and hooks (executable agents/hooks default to `draft-disabled`). Agents/Hooks/Plugins "native conversion" is experimental as of 0.8.24 (audit P1, tracked for a later release).
