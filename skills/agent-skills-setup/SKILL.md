...
bash scripts/smart-ide-migration.sh --source cursor --target opencode --workspace /path/to/project --objects project-mcp --source-mcp-file /path/to/cursor-export.json --dry-run
# Apply the same validated conversion only after reviewing the preview.
bash scripts/smart-ide-migration.sh --source cursor --target opencode --workspace /path/to/project --objects project-mcp --source-mcp-file /path/to/cursor-export.json --strategy backup --yes
```
